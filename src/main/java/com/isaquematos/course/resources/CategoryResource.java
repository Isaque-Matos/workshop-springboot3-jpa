...
import com.isaquematos.course.services.CategoryService;

@RestController //Cria controladores, indica que a classe contém métodos que vão responder com dados diretamente (JSON ou XML)
@RequestMapping(value = "/categories") // anotação usada para mapear requisições HTTP para métodos específicos
